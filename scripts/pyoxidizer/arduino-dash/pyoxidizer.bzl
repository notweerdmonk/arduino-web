...
def make_exe():
    ...
    python_config.run_module = "arduino_dash.__main__"
    ...
    local_wheels = exe.pip_download([
        ...
        "/home/weerdmonk/Projects/medminder/arduino_dash/python/arduino_dash/dist/arduino-dash/arduino_dash-0.1.0-py3-none-any.whl",
    ])
